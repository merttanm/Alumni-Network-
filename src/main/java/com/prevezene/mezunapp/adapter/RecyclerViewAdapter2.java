...
public class RecyclerViewAdapter2 extends RecyclerView.Adapter<RecyclerViewAdapter2.RowHolder> {
    public ArrayList<paper_model> paperList2;
// renkleri beyaz yaptım
    public String[] colors = {"#F8F7FA","#F8F7FA","#F8F7FA","#F8F7FA","#F8F7FA","#F8F7FA","#F8F7FA","#F8F7FA"};

    public RecyclerViewAdapter2(ArrayList<paper_model> paperList) {
        this.paperList2 = paperList;
    }
    @NonNull
    @Override
    ...
    public void onBindViewHolder(@NonNull RowHolder holder, int position) {
        holder.bind(paperList2.get(position),colors,position);
    }
    @Override
    public int getItemCount() {
        return paperList2.size();
    }
    ...
    public class RowHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(paper_model papermodel,String[] colors, Integer position) {
            ...
            textName.setText(papermodel.paper_two);
